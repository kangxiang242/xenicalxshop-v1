                    ...
                    <div class="goods">
                        <div class="atlas">
                            ...
                            <div class="thumbnail">
                                ...
                                @foreach($goods_thumbnail as $key=>$item)
                        ...
                        <div class="info">
                            ...
                            <div class="place">
                                <a href="{{ url('checkout/'.$product->id) }}">{{ $product->price >= app('cache.config')->get('freight_where')?"免運訂購":"立即訂購" }}</a>
                            </div>
                            ...
                            <div class="content">
                                <table>
                                    <thead>
                                        <tr>
                                            <th></th>
                                            <th width="180">限時下殺優惠價</th>
                                            <th width="180">平均每盒</th>
                                            <th></th>
                                        </tr>
                                    </thead>
                                    ...
                                    @foreach($discount as $item)
                                        <tr>
                                            <td><p>{{ $item->name }}</p><p style="text-decoration: line-through;font-weight: 100">組合價NT$ {{ number_format(round($item->market_price)) }}</p></td>
                                            <td>NT${{ number_format(round($item->price)) }}</td>
                                            <td>NT${{ number_format(round($item->price/$item->quantity)) }}</td>
                                            <td><a class="choice" href="{{ url('product/'.$item->id) }}">選擇該方案</a></td>
                                        </tr>
                                    @endforeach
                ...
                <div class="main">
                    <div class="final">
                        <div class="content">
                            ...
                            <div class="gallery">
                                <img src="{{ asset_upload(app('cache.config')->get('goods_conceal_img')) }}" alt="隐秘配送">
