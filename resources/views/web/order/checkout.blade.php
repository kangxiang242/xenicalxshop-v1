...
@section('content')
    ...
    <div class="checkout-container">
        <form id="order-form" data-track-checkout onsubmit="return orderStore();" method="POST" action="{{ url('order') }}">
            {{ csrf_field() }}
            <div class="checkout-wrapper">
                <ul class="step">
                    <li class="art">填寫配送資料</li>
                    <li>確認訂單</li>
                    <li>建立訂單</li>
                </ul>
                ...
                <div class="main">
                    ...
                    <div class="base-column">
                        <p class="title">配送資料</p>
                        <div class="mater">
                            <div class="form-group" style="width: 360px">
                                <input class="form-control" type="text" name="name" data-track-field="name" id="name">
                                <label class="shut" for="name">請問如何稱呼您</label>
                            </div>
                            <div class="form-group" style="width: 360px">
                                <input class="form-control" type="tel" name="phone" data-track-field="phone" id="phone" maxlength="10" oninput="this.value=this.value.replace(/[^0-9]/g,'')">
                                <label class="shut" for="phone">請留下您收件時使用的電話號碼</label>
                            </div>
                            <div class="form-group" style="width: 360px">
                                <input class="form-control" type="text" name="email" data-track-field="email" id="email">
                                ...
                                <div class="radio-box">
                                    ...
                                    <div class="form-radio">
                                        ...
                                        <label class="radio-label" for="order-type-1">
                                            ...
                                            <span class="text">7-ELEVEN 統一超商<br>取貨付款</span>
                                        </label>
                                    </div>
                                    ...
                                    <div class="form-radio">
                                        ...
                                        <label class="radio-label" for="order-type-0">
                                            ...
                                            <span class="text">黑貓宅急便</br>貨到付款</span>
                                        </label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-select">
                                    <div class="select-box" id="load-1">
                                        <select name="city" data-track-field="city" id="city">
                                            <option value="0">選擇縣市</option>
                                        </select>
                                    </div>

                                    <div class="select-box" id="load-2">
                                        <select name="county" data-track-field="county" id="county">
                                            <option value="0">選擇地區</option>
                                        </select>
                                    </div>

                                    <div class="select-box" id="load-3">
                                        <select name="street" data-track-field="street" id="street">
                                ...
                                <div class="form-address" id="form-address-row">
                                    <input class="form-control" type="text" name="address" data-track-field="address" id="address">
                    ...
                    <div class="count-column">
                        <div class="card">
                            ...
                            <div class="census">
                                ...
                                <div class="compute">
                                    ...
                                    <dl>
                                        <dt>
                                            <p class="p-title">運費<span class="grep" style="font-size: 12px;">（訂購套裝可享受官方免費配送服務）</span></p>
                        ...
                        <button class="submit-btn" type="submit" data-track-section="checkout" data-track-name="checkout.submit.click" data-observer="提交訂單按鈕">建立訂單</button>
                        <div class="others-sec">
                            <!-- <div class="others">
                                ...
                                <div class="other-sub">
                                    ...
                                    <img src="/static/img/message.jpg" alt="訂購提醒" loading="lazy" decoding="async">
                                </div>
                            </div> -->
                            <div class="sales-sec">
